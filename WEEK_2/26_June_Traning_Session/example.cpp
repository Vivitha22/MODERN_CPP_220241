...
int main(){
    ...
    // Demo(&fn);//will not work because the fn is taken as object 
    Demo(+fn); // this will work
    //because the '+' symbol will convert the object{lambda} to a function pointer
}


//lambda is a function of the user but for compiler it is an object
